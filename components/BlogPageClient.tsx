...
interface BlogPageClientProps {
  programacionPosts: Post[];
  otrosPosts: Post[];
}

export default function BlogPageClient({ programacionPosts, otrosPosts }: BlogPageClientProps) {
      ...
      <div className="container mx-auto px-4">
        ...
        {currentPosts.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-400 text-lg">No hay posts en esta categoría aún.</p>
          </div>
        )}
      </div>
    </div>
