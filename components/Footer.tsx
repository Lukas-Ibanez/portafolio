...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/lukas-ibanez',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      href: 'mailto:lukas.ibanez@example.com',
      icon: (
  ...
  return (
    <footer ref={footerRef} className="border-t border-gray-800/50 mt-20 bg-black/60 backdrop-blur-xl">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Lukas Ibáñez. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
